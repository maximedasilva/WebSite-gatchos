...
<html>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="#">Home</a></li>
                                    <?php
            $requeteinscrit="select count(*) as inscrit from Inscription where Musicien_idMusicien=".$_SESSION["CODE_MUSE"].">=NOW()"; 
        ...
        <form method="post" action="InsertionSortie.php">
            ...
            <input class="form-control" name="NomSortie" type="text" id="NomSortie" placeholder="Rentrer ici le nom de la sortie "></div> <div class="form-group">
            ...
            <input class="btn btn-default" type="submit" value="NouvelleSortie"/>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <th>Nom</th><th>Date</th><th>Supprimer</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>    <td><a href="SuppressionSortie.php?sortie=<?php echo $row['idSortie']; ?>"><span class="glyphicon glyphicon-remove"</a></td><?php
                        }
                        echo'   </tr>';
